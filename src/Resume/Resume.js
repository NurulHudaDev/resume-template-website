...
const Resume = () => {
    ...
    return (
        <div className='resume1'>
            <div className='container grid grid-cols-2 md:grid-cols-2 lg:grid-cols-2'>
                <div className='left-side'>
                    ...
                    <div className='contactInfo'>
                        <h3 className='titele'>Contact Info</h3>
                        <ul>
                            <li>
                    ...
                    <div className='contactInfo education'>
                        <h3 className='titele'>Education</h3>
                        <ul>
                            <li>
                                <h5>2011-2012</h5>
                                <h4>SSC</h4>
                    ...
                    <div className='contactInfo languag'>
                        <h3 className='titele'>Languag</h3>
                        <ul>
                            <li>
